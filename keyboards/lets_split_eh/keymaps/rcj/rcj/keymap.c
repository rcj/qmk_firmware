...
[_MOVEMENT] = LAYOUT( \
  ...
  _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_DOT,  KC_4,    KC_5,    KC_6,    _______, _______, \
  _______, _______, KC_INS,  _______, _______, KC_PSCR, KC_COMM, KC_1,    KC_2,    KC_3,    _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
),
